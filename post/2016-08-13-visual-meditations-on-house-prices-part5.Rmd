...
```{r ,fig-nar-slopes, warning=FALSE, cache=TRUE,echo=TRUE, message=FALSE,fig.height=5,fig.width=6.5 }
...
```{r ,fig-nar-dot-1, warning=FALSE, cache=TRUE,echo=TRUE, message=FALSE,fig.height=5,fig.width=6 }
...
```{r ,fig-nar-combo-1, warning=FALSE, cache=TRUE,echo=TRUE, message=FALSE,fig.height=7,fig.width=10 }
...
```{r ,fig-nar-combo-2, warning=FALSE, cache=TRUE,echo=TRUE, eval=F,message=FALSE,fig.height=7,fig.width=10 }
...
```{r ,fig-nar-fmhpi-dots-1, warning=F, cache=T,echo=T, eval=T,message=F,fig.height=4.5,fig.width=6 }
#load data
...
```{r ,fig-nar-fmhpi-dots-2, warning=F, cache=T,echo=T, eval=F,message=F,fig.height=4.5,fig.width=6 }
...
```{r ,fig-nar-fmhpi-dots-3, warning=F, cache=T,echo=T, eval=F,message=F,fig.height=4.5,fig.width=6 }
