...
I've been collecting various graphical thoughts about house prices in my Visual Meditations series. For reference, the prior meditations are listed below, and I'll keep an updated list of all of them [here](~/2016/05/08/2016-05-08-visual-meditations-on-house-prices ).
...
```{r ,fig-hpimed6-viz1, warning=FALSE, cache=TRUE,echo=T, message=FALSE,warnings=FALSE,,fig.height=5,fig.width=7}
...
```{r ,fig-hpimed6-viz2, warning=FALSE, cache=TRUE,echo=T, message=FALSE,warnings=FALSE ,,fig.height=5,fig.width=7}
ggplot(data=d.metro,aes(x=date,fill=region,color=region))+
  geom_ribbon(aes(ymin=hpa12.rmin,ymax=hpa12.r5),alpha=0.1)+
  geom_ribbon(aes(ymin=hpa12.r5,ymax=hpa12.r25),alpha=0.5)+
  geom_ribbon(aes(ymin=hpa12.r25,ymax=hpa12.r75),alpha=0.75)+
...
We can also animated a version using tweenr.See my earlier [post about tweenr](../2016-05-29-improving-R-animated-gifs-with-tweenr ) for an introduction to tweenr, and more examples [here](../2016-05-30-more-tweenr-animations ) and [here](../2016-06-26-week-in-review ). 

```{r ,fig-hpimed6-viz3, warning=FALSE, eval=F,cache=TRUE,echo=T, message=FALSE,warnings=FALSE,fig.height=5,fig.width=7}
